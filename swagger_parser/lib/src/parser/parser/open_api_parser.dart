        ...
        for (final rawParameter in map[_parametersConst] as List<dynamic>) {
          ...
          if (isRefParameter) {
            ...
            final isRefParameterExist = _definitionFileContent.containsKey(_componentsConst) &&
                ...
                ((_definitionFileContent[_componentsConst] as Map<String, dynamic>)[_parametersConst] as Map<String, dynamic>)
            ...
            parameter = ((_definitionFileContent[_componentsConst] as Map<String, dynamic>)[_parametersConst]
      ...
      if (map.containsKey(_requestBodyConst)) {
        ...
        if (isRefBody) {
          ...
          final isRefBodyExist = _definitionFileContent.containsKey(_componentsConst) &&
              ...
              ((_definitionFileContent[_componentsConst] as Map<String, dynamic>)[_requestBodiesConst] as Map<String, dynamic>)
          ...
          requestBody = ((_definitionFileContent[_componentsConst] as Map<String, dynamic>)[_requestBodiesConst] as Map<String, dynamic>)[refBodyName]
        ...
        if (contentTypes.containsKey(_multipartFormDataConst)) {
          ...
          final content =
              contentTypes.containsKey(config.defaultContentType) ? contentTypes[config.defaultContentType] : contentTypes.entries.firstOrNull?.value;
    ...
    (_definitionFileContent[_pathsConst] as Map<String, dynamic>).forEach((path, pathValue) {
      ...
      pathValue.forEach((key, requestPath) {
        ...
        final parametersDescription =
            parameters.where((e) => e.description != null).map((e) => '[${e.name?.toCamel ?? 'body'}] - ${e.description}').join('\n\n').trim();
          ...
          if (item1 is Map<String, dynamic> && item2 is Map<String, dynamic>) {
            ...
            if (nullableItem != null) {
              ...
              if (type.wrappingCollections.isEmpty) {
                ...
                ofType = type.copyWith(wrappingCollections: wrappingCollections);
              }
            }
          }
        }
    ...
    // Type or ref
      ...
      if (map.containsKey(_refConst)) {
        import = _formatRef(map).toPascal;
          ...
          map[_additionalPropertiesConst] is Map<String, dynamic> &&
          (map[_additionalPropertiesConst] as Map<String, dynamic>).containsKey(_refConst)) {
        import = _formatRef(map[_additionalPropertiesConst] as Map<String, dynamic>).toPascal;
      }
      ...
      return (
        type: UniversalType(
          ...
          format: map[_formatConst]?.toString(),
          jsonKey: name,
          defaultValue: protectDefaultValue(defaultValue, isEnum: enumType != null),
          enumType: enumType,
          isRequired: isRequired,
          nullable: map[_nullableConst].toString().toBool() ?? (root && !isRequired),
        ),
